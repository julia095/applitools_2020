@768x700
Feature: Cross-Device Elements Test for 768x700 viewport
        ...
        Scenario: Filter icon description contains 'Filters'
             Then I see the element with id SPAN____208 contains Filters

        Scenario: Tileview grid button is not present on the page
             Then I cannot see the button with id I__tiviewgrid__202

        Scenario: Tileview list button is not present on the page
             Then I cannot see the button with id I__tiviewlist__204
